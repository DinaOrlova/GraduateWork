...
5. Для формирования отчета Allure ввести команду `gradlew allureServe`.
   
6. Для работы с другой БД сначала необходимо выполнить остановку работы приложения, нажав Ctrl+С во вкладке терминала, в которой было запущено приложение.
7. После окончания тестов завершить работу контейнеров командой `docker-compose down`.
